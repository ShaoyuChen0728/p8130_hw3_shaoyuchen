...
a 100 (1 − 𝛼) % confidence interval for one population proportion is given by: $$(\hat{p}-z_{1-\alpha/2}\sqrt{\frac{\hat{p}(1-\hat{p})}{n}},\hat{p}+z_{1-\alpha/2}\sqrt{\frac{\hat{p}(1-\hat{p})}{n}})$$
...
Conduct a one-sided hypothesis test at the 𝛼 = 0.1 level. In this test, we want to see if
